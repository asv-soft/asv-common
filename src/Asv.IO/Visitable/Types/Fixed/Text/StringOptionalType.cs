...
public sealed class StringOptionalType(
    EncodingId encoding,
    uint minSize,
    uint maxSize,
...
) : FieldType<StringOptionalType, string?>
{
    ...
    public static readonly StringOptionalType Ascii = new(
        EncodingId.Ascii,
        DefaultMinSize,
        DefaultMaxSize
    );
    public static readonly StringOptionalType Utf8 = new(
        EncodingId.Utf8,
        DefaultMinSize,
        DefaultMaxSize
    );
    public static readonly StringOptionalType Utf16 = new(
        EncodingId.Utf16,
        DefaultMinSize,
        DefaultMaxSize
    );
    public static readonly StringOptionalType Utf32 = new(
        EncodingId.Utf32,
        DefaultMinSize,
        DefaultMaxSize
    );
