...
namespace Asv.IO.Test
{
    public class SpanBitHelperTest
    {
        ...
        public void FixedPointS3TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS4TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS5TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS6TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS7TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS8TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS9TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS10TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS11TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS12TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS13TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS14TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS15TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS17TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS18TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS19TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS20TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS21TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS22TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS23TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS24TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS25TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS26TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS27TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS28TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS29TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS30TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS31TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, Fraction1)]
        [InlineData(double.NegativeInfinity, double.NegativeInfinity, Fraction1)]
        public void FixedPointS32TestFraction(double writed, double expected, double fraction)
        {
            var data = new byte[256];
            var writeSpan = new Span<byte>(data);
            var readSpan = new ReadOnlySpan<byte>(data);
