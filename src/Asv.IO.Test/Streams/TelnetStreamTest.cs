...
namespace Asv.IO.Test
{
    public class TelnetStreamTest
    {
        ...
        public async Task ReadWriteMessageTest()
        {
            ...
            strm1.OnReceive.Where(_ => _.Equals(message1)).Subscribe(_ => strm1.Send(message2, CancellationToken.None).Wait(1000));
        ...
        public async Task BufferOverflow()
        {
            ...
            using var a = strm2.OnError.Take(1).Subscribe(_=>
            {
