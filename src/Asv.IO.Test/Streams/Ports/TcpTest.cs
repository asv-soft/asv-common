...
{
    public static TcpClientPort CreateTcpClient(string host = "127.0.0.1", int port = 5050) =>
        new(
            new TcpPortConfig
            {
                Host = host,
    ...
    public static TcpServerPort CreateTcpServer(string host = "127.0.0.1", int port = 5050) =>
        new(
            new TcpPortConfig
            {
                Host = host,
