...
namespace Asv.Common
{
    public static partial class GeoPointLongitude
    {
        ...
        public static bool TryParse(string? value, out double longitude)
        {
            ...
            if (degGroup.Success == false && minGroup.Success == false && secGroup.Success == false)
            {
                return false;
            }
            ...
            if (secGroup.Success)
            {
                ...
                var valuableDigitsCount = secGroup.Value.Split('.').Last().Length;
