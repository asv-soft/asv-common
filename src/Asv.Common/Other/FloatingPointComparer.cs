...
public static class FloatingPointComparer
{
    ...
    /// </summary>
    public static bool ApproximatelyEquals<T>(this T first, T second, T epsilon)
        where T : IFloatingPoint<T>
    {
        if (
            T.IsNegativeInfinity(first) && T.IsNegativeInfinity(second)
    ...
    /// </summary>
    public static bool ApproximatelyEquals<T>(this T first, T second)
        where T : IFloatingPoint<T>
    {
    ...
    /// </summary>
    public static bool ApproximatelyNotEquals<T>(this T first, T second, T epsilon)
        where T : IFloatingPoint<T>
    {
    ...
    /// </summary>
    public static bool ApproximatelyNotEquals<T>(this T first, T second)
        where T : IFloatingPoint<T>
    {
