...
namespace Asv.Common
{
    public interface ILinkIndicator
    {
        ...
        /// </summary>
        Observable<Unit> OnFound =>
            State.Where(x => x == LinkState.Connected).Select(_ => Unit.Default);
        ...
        /// </remarks>
        Observable<Unit> OnLost =>
            State.Where(x => x == LinkState.Disconnected).Select(_ => Unit.Default);
    }
