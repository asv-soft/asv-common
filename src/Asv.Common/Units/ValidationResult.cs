...
public readonly struct ValidationResult
{
    ...
    public static ValidationResult FailAsNullOrWhiteSpace { get; } =
        new()
        {
            IsSuccess = false,
    ...
    public static ValidationResult FailAsInvalidCharacters { get; } =
        new()
        {
            IsSuccess = false,
    ...
    public static ValidationResult FailAsUnknown { get; } = new UnknownValidationException();
