...
public class CircularBuffer2<T> : IEnumerable<T>
{
    ...
    /// <summary>
    /// Gets maximum capacity of the buffer. Elements pushed into the buffer after
    /// maximum capacity is reached (IsFull = true), will remove an element.
    /// </summary>
    public int Capacity => _bufferLength;

    /// <summary>
    /// Gets a value indicating whether boolean indicating if Circular is at full capacity.
    ...
    /// <summary>
    /// Gets a value indicating whether true if has no elements.
    /// </summary>
    public bool IsEmpty => Size == 0;

    /// <summary>
    /// Gets current buffer size (the number of elements that the buffer has).
    /// </summary>
    ...
    /// </summary>
    /// <exception>
    ///     <cref>NotImplementedException</cref>
    /// </exception>
    public void Clear()
    {
    ...
    /// </para>
    /// <para><remarks>Segments may be empty.</remarks></para>
    /// </summary>
